          ...
          <div className="w-full max-w-md relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-1">
                <label className="text-sm font-medium ml-1 text-gray-600">
                  Username
                </label>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="block w-full pl-12 pr-4 py-4 border rounded-xl focus:outline-none transition-all duration-200 font-medium placeholder-gray-600 text-black"
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="block w-full pl-12 pr-12 py-4 border rounded-xl focus:outline-none transition-all duration-200 font-medium placeholder-gray-600 text-black"
                    style={{
                      borderColor: "#000",
                    }}
                    onFocus={(e) => {
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-500 hover:text-gray-300 transition-colors cursor-pointer z-20"
                  >
                    {showPassword ? (
